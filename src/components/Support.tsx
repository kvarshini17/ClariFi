    ...
    if ((this as any).state.hasError) {
      ...
      return (
        <div className="min-h-[400px] flex items-center justify-center p-8">
          <div className="max-w-md w-full bg-card border border-border rounded-[32px] p-8 text-center space-y-6 shadow-2xl">
            <div className="w-16 h-16 bg-expense/10 rounded-2xl flex items-center justify-center mx-auto">
              <AlertCircle className="text-expense" size={32} />
            </div>
            <div className="space-y-2">
              <h3 className="text-xl font-black text-primary tracking-tight">Application Error</h3>
            ...
            <button 
              ...
              className="w-full py-4 bg-card text-primary rounded-2xl font-black text-xs uppercase tracking-widest hover:scale-[1.02] active:scale-[0.98] transition-all"
            >
              Reload Application
            </button>
          </div>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[1100] flex items-center justify-center p-4">
          ...
          <motion.div 
            ...
            className="relative z-10 w-full max-w-md bg-white dark:bg-zinc-950 border border-border rounded-[32px] shadow-2xl overflow-hidden flex flex-col h-[550px] will-change-transform"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="p-6 bg-zinc-50 dark:bg-white/5 border-b border-border flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-accent rounded-2xl flex items-center justify-center text-zinc-950">
                  <Bot size={24} />
                </div>
                <div>
                  <h3 className="text-lg font-black text-primary tracking-tight">Clari Assistant</h3>
                  <div className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-accent animate-pulse" />
                    <span className="text-[11px] font-bold text-accent uppercase tracking-widest">Online</span>
                  </div>
                </div>
              </div>
              <button 
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4 custom-scrollbar">
              {chatMessages.map((msg, i) => (
                ...
                >
                  <div className={`max-w-[80%] p-4 rounded-2xl text-sm font-medium leading-relaxed ${
                    msg.role === 'user' 
                      ? 'bg-accent text-zinc-950 rounded-tr-none' 
                      : 'bg-zinc-100 dark:bg-white/5 text-primary rounded-tl-none border border-border'
                  }`}>
                    {msg.content}
                  </div>
                </motion.div>
              ...
              {isTyping && (
                <div className="flex justify-start">
                  <div className="bg-zinc-100 dark:bg-white/5 p-4 rounded-2xl rounded-tl-none border border-border">
            ...
            <form onSubmit={handleSendMessage} className="p-6 bg-zinc-50 dark:bg-white/5 border-t border-border">
              <div className="relative">
                <input 
                  ...
                  className="w-full bg-card border border-border rounded-2xl py-4 pl-6 pr-14 text-sm font-medium focus:ring-2 focus:ring-emerald-500 outline-none transition-all"
                />
                <button 
                  type="submit"
                  disabled={!userInput.trim() || isTyping}
                  className="absolute right-2 top-1/2 -translate-y-1/2 p-3 bg-accent text-zinc-950 rounded-xl hover:scale-105 active:scale-95 transition-all disabled:opacity-50 disabled:scale-100"
                >
                  <Send size={18} />
                </button>
              </div>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[1100] flex items-center justify-center p-4">
          ...
          <motion.div 
            ...
            animate={{ opacity: 1, scale: 1, y: 0 }}
            exit={{ opacity: 0, scale: 0.95, y: 20 }}
            className="relative z-10 w-full max-w-md bg-white dark:bg-zinc-950 border border-border rounded-[32px] shadow-2xl overflow-hidden flex flex-col will-change-transform"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="p-6 bg-zinc-50 dark:bg-white/5 border-b border-border flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-xl font-black text-primary tracking-tight">Contact Support</h3>
            ...
            <div className="p-6">
              {submitSuccess ? (
                ...
                >
                  ...
                  <div className="space-y-2">
                    <h4 className="text-2xl font-black text-primary tracking-tight">Message Sent!</h4>
                ...
                <form onSubmit={handleContactSubmit} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full bg-zinc-50 dark:bg-white/5 border border-border rounded-2xl py-4 px-6 text-sm font-medium focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[13px] font-black text-zinc-500 uppercase tracking-widest flex items-center gap-2">
                    ...
                    <textarea 
                      ...
                      className="w-full bg-zinc-50 dark:bg-white/5 border border-border rounded-2xl py-4 px-6 text-sm font-medium focus:ring-2 focus:ring-blue-500 outline-none transition-all resize-none"
                    />
                  </div>
                  <button 
                    type="submit"
                    disabled={isSubmitting}
                    className="w-full py-4 bg-card text-primary rounded-2xl font-black text-xs uppercase tracking-widest flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50 disabled:scale-100"
                  >
                    {isSubmitting ? (
                      <>
...
const CategoryCard = React.memo(({ cat, index }: { cat: any, index: number }) => (
  <motion.div
    ...
    onClick={cat.onClick}
    className="bg-card border border-border p-8 rounded-[40px] space-y-8 hover:border-accent/30 transition-all group cursor-pointer shadow-xl shadow-black/5 relative overflow-hidden will-change-transform h-full flex flex-col"
  >
    <div className="absolute top-0 right-0 w-32 h-32 bg-accent/5 blur-2xl -mr-16 -mt-16 group-hover:bg-accent/10 transition-colors hidden sm:block" />
    ...
    <div className="space-y-3 relative z-10">
      <h3 className="text-[25px] font-black text-primary tracking-tight">{cat.title}</h3>
    ...
    <div className="pt-4 mt-auto relative z-10">
      <div className="inline-flex items-center gap-2 text-[12px] font-black uppercase tracking-widest text-accent group-hover:gap-4 transition-all leading-[34px]">
        {cat.action}
...
const FAQItem = React.memo(({ faq, index, isExpanded, onToggle }: { faq: any, index: number, isExpanded: boolean, onToggle: () => void }) => (
  <div className="bg-card border border-border rounded-3xl overflow-hidden transition-all hover:shadow-xl hover:shadow-black/5 will-change-transform">
    <button 
      onClick={onToggle}
    ...
    >
      <p className="font-black text-primary text-lg tracking-tight">{faq.question}</p>
      <div className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all ${isExpanded ? 'bg-accent text-zinc-950 rotate-180' : 'bg-zinc-100 dark:bg-white/5 text-zinc-400'}`}>
        <ChevronDown size={20} />
      </div>
    </button>
...
const SystemHealth = React.memo(({ systemStatus }: { systemStatus: any[] }) => (
  <div className="bg-card border border-border p-10 rounded-[40px] space-y-8 shadow-xl shadow-black/5 relative overflow-hidden">
        ...
        <div key={i} className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[11px] font-black text-accent uppercase tracking-widest">{service.status}</span>
            </div>
          </div>
    ...
    <div className="flex items-center gap-4 p-6 bg-accent/5 border border-accent/10 rounded-3xl">
      <div className="w-10 h-10 bg-accent/20 rounded-xl flex items-center justify-center text-accent">
        <CheckCircle2 size={24} />
      </div>
      <p className="text-sm font-bold text-accent dark:text-emerald-400">All systems are operational. No issues reported in the last 24 hours.</p>
    </div>
  </div>
));
...
const ResourceCard = React.memo(({ icon: Icon, title, subtitle, onClick, colorClass, hoverClass }: { icon: any, title: string, subtitle: string, onClick: () => void, colorClass: string, hoverClass: string }) => (
  <div 
    onClick={onClick}
    className={`bg-card border border-border p-8 rounded-[32px] flex items-center justify-between ${hoverClass} transition-all cursor-pointer group shadow-xl shadow-black/5 will-change-transform`}
  >
    <div className="flex items-center gap-6">
      ...
      <div>
        <p className="font-black text-primary text-xl tracking-tight">{title}</p>
...
const TicketItem = React.memo(({ ticket, isAdmin, onReply, onClose, isReplying, replyText, setReplyText, onCancelReply, onSendReply, isSubmitting }: { 
  ...
  <motion.div 
    ...
    className="p-6 bg-card border border-border rounded-[32px] space-y-6 shadow-xl shadow-black/5 will-change-transform"
  >
    <div className="flex flex-col gap-4">
      <div className="space-y-2">
        <h4 className="text-xl font-black text-primary tracking-tight">{ticket.subject}</h4>
    ...
    <div className="p-6 bg-zinc-50 dark:bg-white/5 rounded-2xl border border-border">
      <p className="text-[15px] text-secondary leading-relaxed font-medium">{ticket.message}</p>
    </div>
    
    {ticket.reply && (
      <div className="p-6 bg-accent/5 border border-accent/10 rounded-2xl space-y-3 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-1 h-full bg-accent" />
        <div className="flex items-center gap-2">
          <Bot size={14} className="text-accent" />
          <p className="text-[11px] font-black text-accent uppercase tracking-widest">Official Response</p>
        </div>
        <p className="text-sm text-primary font-bold leading-relaxed">{ticket.reply}</p>
      </div>
    )}
        ...
        {isReplying ? (
          <form onSubmit={onSendReply} className="space-y-4">
            <div className="space-y-2">
              ...
              <textarea 
                ...
                className="w-full bg-white dark:bg-zinc-950 border border-border rounded-2xl p-6 text-sm font-medium focus:ring-4 focus:ring-emerald-500/10 focus:border-accent outline-none transition-all resize-none"
                rows={4}
              />
            </div>
            <div className="flex gap-3">
              <button 
                type="submit"
                disabled={isSubmitting}
                className="px-8 py-3 bg-accent text-zinc-950 rounded-xl text-[11px] font-black uppercase tracking-widest disabled:opacity-50 hover:scale-105 active:scale-95 transition-all shadow-lg shadow-emerald-500/20"
              >
              ...
              <button 
                ...
                className="px-8 py-3 bg-zinc-100 dark:bg-white/5 text-primary rounded-xl text-[11px] font-black uppercase tracking-widest hover:bg-zinc-200 dark:hover:bg-white/10 transition-all"
              >
                Cancel
              </button>
            </div>
          ...
          <div className="flex gap-3">
            <button 
              ...
              className="px-8 py-3 bg-card text-primary rounded-xl text-[11px] font-black uppercase tracking-widest hover:scale-105 active:scale-95 transition-all shadow-lg shadow-black/10 dark:shadow-white/10"
            >
              Reply to User
            </button>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[1100] flex items-center justify-center p-4">
          ...
          <motion.div 
            ...
            animate={{ opacity: 1, scale: 1, y: 0 }}
            exit={{ opacity: 0, scale: 0.95, y: 20 }}
            className="relative z-10 w-full max-w-2xl bg-white dark:bg-zinc-950 border border-border rounded-[32px] shadow-2xl overflow-hidden flex flex-col h-[80vh] will-change-transform"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="p-6 bg-zinc-50 dark:bg-white/5 border-b border-border flex items-center justify-between">
              <div>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar bg-zinc-50/50 dark:bg-zinc-900/50">
              <div className="relative mb-4">
                ...
                <input 
                  ...
                  className="w-full bg-white dark:bg-zinc-950 border border-border rounded-2xl py-4 pl-14 pr-24 text-sm font-medium focus:ring-4 focus:ring-emerald-500/10 focus:border-accent outline-none transition-all"
                />
                {ticketSearch && (
                  <button 
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[1100] flex items-center justify-center p-4">
          ...
          <motion.div 
            ...
            animate={{ opacity: 1, scale: 1, y: 0 }}
            exit={{ opacity: 0, scale: 0.95, y: 20 }}
            className="relative z-10 w-full max-w-4xl bg-white dark:bg-zinc-950 border border-border rounded-[32px] shadow-2xl overflow-hidden flex flex-col md:flex-row h-[85vh] md:h-[80vh] will-change-transform"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="w-full md:w-72 bg-zinc-50 dark:bg-white/5 border-b md:border-b-0 md:border-r border-border p-6 md:p-8 flex flex-col gap-6 md:gap-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-black text-primary tracking-tight">Docs</h3>
                ...
                >
                  {activeDocSection === 'getting-started' && (
                    <div className="space-y-6">
                      <h4 className="text-4xl font-black text-primary tracking-tight">Getting Started</h4>
                      ...
                      <div className="p-8 bg-zinc-50 dark:bg-white/5 rounded-3xl border border-border space-y-4">
                        <h5 className="font-black text-primary">Quick Setup</h5>
                  ...
                  {activeDocSection === 'features' && (
                    <div className="space-y-8">
                      <h4 className="text-4xl font-black text-primary tracking-tight">Core Features</h4>
                      <div className="grid grid-cols-1 gap-6">
                        <div className="p-8 bg-zinc-50 dark:bg-white/5 rounded-3xl border border-border space-y-4">
                          <div className="w-12 h-12 bg-accent/10 rounded-2xl flex items-center justify-center text-accent">
                            <Bot size={24} />
                          </div>
                          <h5 className="text-xl font-black text-primary">AI Receipt Scanning</h5>
                          <p className="text-zinc-500 leading-relaxed font-medium">
                        ...
                        <div className="p-8 bg-zinc-50 dark:bg-white/5 rounded-3xl border border-border space-y-4">
                          ...
                          <h5 className="text-xl font-black text-primary">Smart Budgets</h5>
                          <p className="text-zinc-500 leading-relaxed font-medium">
                  ...
                  {activeDocSection === 'financial-dna' && (
                    <div className="space-y-6">
                      <h4 className="text-4xl font-black text-primary tracking-tight">Financial DNA</h4>
                      <p className="text-lg text-zinc-500 leading-relaxed font-medium">
                  ...
                  {activeDocSection === 'pro-tips' && (
                    <div className="space-y-6">
                      <h4 className="text-4xl font-black text-primary tracking-tight">Pro Tips</h4>
                      <div className="space-y-4">
                        <div className="p-8 bg-accent rounded-[32px] text-zinc-950 shadow-xl shadow-emerald-500/20">
                        ...
                        <div className="p-8 bg-card rounded-[32px] text-primary shadow-xl shadow-black/10">
          ...
          >
            <div className="w-full md:w-72 bg-zinc-50 dark:bg-white/5 border-b md:border-b-0 md:border-r border-border p-6 md:p-8 flex flex-col gap-6 md:gap-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-black text-primary tracking-tight">Guide</h3>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  {activeGuideSection === 'dashboard' && (
                    <div className="space-y-6">
                      <h4 className="text-4xl font-black text-primary tracking-tight">Dashboard Overview</h4>
                      <p className="text-lg text-zinc-500 leading-relaxed font-medium">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div className="p-6 bg-zinc-50 dark:bg-white/5 rounded-2xl border border-border">
                          ...
                          <p className="text-2xl font-black text-accent">$3,210.00</p>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  {activeGuideSection === 'transactions' && (
                    <div className="space-y-6">
                      <h4 className="text-4xl font-black text-primary tracking-tight">Adding Transactions</h4>
                      <p className="text-lg text-zinc-500 leading-relaxed font-medium">
                      ...
                      <div className="p-8 bg-blue-500/5 border border-blue-500/10 rounded-3xl space-y-4">
                        <h5 className="font-black text-primary">AI Scanner Pro Tip</h5>
                  ...
                  {activeGuideSection === 'budgets' && (
                    <div className="space-y-6">
                      <h4 className="text-4xl font-black text-primary tracking-tight">Setting Budgets</h4>
                      <p className="text-lg text-zinc-500 leading-relaxed font-medium">
                      ...
                      <div className="space-y-4">
                        {['Food & Dining', 'Transportation', 'Entertainment'].map((cat, i) => (
                          <div key={i} className="p-4 bg-zinc-50 dark:bg-white/5 rounded-xl border border-border flex items-center justify-between">
                            <span className="text-sm font-bold text-primary">{cat}</span>
                  ...
                  {activeGuideSection === 'goals' && (
                    <div className="space-y-6">
                      <h4 className="text-4xl font-black text-primary tracking-tight">Financial Goals</h4>
                      <p className="text-lg text-zinc-500 leading-relaxed font-medium">
                  ...
                  {activeGuideSection === 'support' && (
                    <div className="space-y-6">
                      <h4 className="text-4xl font-black text-primary tracking-tight">Support & Help</h4>
                      <p className="text-lg text-zinc-500 leading-relaxed font-medium">
                        Need assistance? We're here to help you get the most out of ClariFi.
                      </p>
                      <div className="grid grid-cols-1 gap-4">
                        <div className="p-6 bg-zinc-50 dark:bg-white/5 rounded-2xl border border-border space-y-2">
                          <h5 className="font-black text-primary">AI Assistant (Clari)</h5>
                        ...
                        <div className="p-6 bg-zinc-50 dark:bg-white/5 rounded-2xl border border-border space-y-2">
                          <h5 className="font-black text-primary">Direct Support</h5>
                        ...
                        <div className="p-6 bg-zinc-50 dark:bg-white/5 rounded-2xl border border-border space-y-2">
                          <h5 className="font-black text-primary">Documentation</h5>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[1100] flex items-center justify-center p-4">
          ...
          >
            <div className="w-full md:w-72 bg-zinc-50 dark:bg-white/5 border-b md:border-b-0 md:border-r border-border p-6 md:p-8 flex flex-col gap-6 md:gap-8">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-accent rounded-2xl flex items-center justify-center text-zinc-950 shadow-lg shadow-emerald-500/20">
                  <Shield size={24} />
                </div>
                <div>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  {activeSecuritySection === 'encryption' && (
                    <div className="space-y-6">
                      <h4 className="text-4xl font-black text-primary tracking-tight">Encryption</h4>
                      <p className="text-lg text-zinc-500 leading-relaxed font-medium">
                        All your financial data is encrypted at rest and in transit using industry-standard protocols.
                      </p>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div className="p-8 bg-zinc-50 dark:bg-white/5 rounded-3xl border border-border space-y-4">
                          <h5 className="font-black text-primary">At Rest</h5>
                        ...
                        <div className="p-8 bg-zinc-50 dark:bg-white/5 rounded-3xl border border-border space-y-4">
                          <h5 className="font-black text-primary">In Transit</h5>
                          <p className="text-sm text-zinc-500 font-medium leading-relaxed">
                  ...
                  {activeSecuritySection === 'auth' && (
                    <div className="space-y-6">
                      <h4 className="text-4xl font-black text-primary tracking-tight">Authentication</h4>
                      <p className="text-lg text-zinc-500 leading-relaxed font-medium">
                      ...
                      <div className="p-8 bg-accent/5 border border-accent/10 rounded-3xl space-y-4">
                        <h5 className="font-black text-primary">No Passwords Stored</h5>
                        <p className="text-sm text-zinc-500 font-medium">
                  ...
                  {activeSecuritySection === 'isolation' && (
                    <div className="space-y-6">
                      <h4 className="text-4xl font-black text-primary tracking-tight">Data Isolation</h4>
                      <p className="text-lg text-zinc-500 leading-relaxed font-medium">
                  ...
                  {activeSecuritySection === 'compliance' && (
                    <div className="space-y-6">
                      <h4 className="text-4xl font-black text-primary tracking-tight">Compliance</h4>
                      <p className="text-lg text-zinc-500 leading-relaxed font-medium">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {['GDPR Compliant', 'CCPA Ready', 'SOC2 Principles', 'Privacy First'].map((item, i) => (
                          <div key={i} className="flex items-center gap-3 p-4 bg-zinc-50 dark:bg-white/5 rounded-2xl border border-border">
                            <CheckCircle2 className="text-accent" size={16} />
                            <span className="text-xs font-black text-primary uppercase tracking-widest">{item}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                  ...
                  {activeSecuritySection === 'privacy' && (
                    <div className="space-y-6">
                      <h4 className="text-4xl font-black text-primary tracking-tight">Data Privacy</h4>
                      <p className="text-lg text-zinc-500 leading-relaxed font-medium">
                        Your privacy is at the core of everything we build. We believe you should always be in control of your data.
                      </p>
                      <div className="grid grid-cols-1 gap-4">
                        <div className="p-6 bg-zinc-50 dark:bg-white/5 rounded-2xl border border-border space-y-2">
                          <h5 className="font-black text-primary">No Data Selling</h5>
                        ...
                        <div className="p-6 bg-zinc-50 dark:bg-white/5 rounded-2xl border border-border space-y-2">
                          <h5 className="font-black text-primary">Anonymized AI</h5>
...
export default function Support({ onBack }: SupportProps) {
  ...
  const adminCategory = isAdmin ? {
    icon: <Shield className="text-expense" size={24} />,
  ...
  return (
    <ErrorBoundary>
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div className="space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent/10 border border-accent/20 text-accent text-[11px] font-black uppercase tracking-widest">
            <LifeBuoy size={12} />
            Support & Help Center
          </div>
          <h3 className="text-4xl md:text-6xl font-black text-primary tracking-tighter leading-tight md:leading-none">
        ...
        <button 
          onClick={onBack}
          className="w-full md:w-auto px-8 py-4 bg-card hover:bg-zinc-50 dark:hover:bg-white/5 text-primary rounded-2xl font-black text-xs uppercase tracking-widest transition-all border border-border shadow-xl shadow-black/5 flex items-center justify-center gap-2 group"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
        <div className="lg:col-span-7 space-y-12">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
            <div className="space-y-2">
              <h3 className="text-3xl font-black text-primary tracking-tight">Common Questions</h3>
              <p className="text-zinc-500 text-xs font-bold uppercase tracking-widest">Everything you need to know</p>
            </div>
            <div className="relative group">
              <Search className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-400 group-focus-within:text-accent transition-colors" size={18} />
              <input 
                type="text"
                placeholder="Search FAQs..."
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="pl-12 pr-6 py-4 bg-card border border-border rounded-2xl text-sm font-medium focus:ring-4 focus:ring-emerald-500/10 focus:border-accent outline-none transition-all w-full sm:w-80 shadow-xl shadow-black/5"
              />
            </div>
          </div>
          ...
          <div className="space-y-4">
            {filteredFaqs.length > 0 ? (
              ...
              <div className="text-center py-20 bg-zinc-50 dark:bg-white/5 rounded-[40px] border-2 border-dashed border-border space-y-4">
                ...
                <div className="space-y-1">
                  <p className="text-primary font-black">No results found</p>
        ...
        <div className="lg:col-span-5 space-y-12">
          <div className="space-y-8">
            <div className="space-y-2">
              <h3 className="text-3xl font-black text-primary tracking-tight">System Health</h3>
          ...
          <div className="space-y-8">
            <div className="space-y-2">
              <h3 className="text-3xl font-black text-primary tracking-tight">Resources</h3>
