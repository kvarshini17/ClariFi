...
export default function BudgetForm({ onClose, onAdd, currencySymbol }: BudgetFormProps) {
    ...
    <div className="p-8 space-y-8">
      <div className="flex justify-between items-center">
        <div className="space-y-2">
          ...
          <p className="text-zinc-500 text-[10px] font-bold uppercase tracking-widest">Define your limit</p>
        </div>
        <button 
          onClick={onClose}
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          <label className="text-[10px] font-black text-zinc-500 uppercase tracking-widest ml-1">Amount ({currencySymbol})</label>
          <input 
            type="number"
        ...
        <div className="space-y-2">
          <label className="text-[10px] font-black text-zinc-500 uppercase tracking-widest ml-1">Alert Threshold ({newBudget.alertThreshold}%)</label>
          <input 
            type="range"
            min="10"
            max="100"
