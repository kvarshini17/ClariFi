    ...
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-3 px-2">
          ...
          <div className="space-y-0.5">
            <h2 className="text-2xl font-black text-zinc-900 dark:text-white tracking-tight">Financial Summary</h2>
            <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Real-time Overview</p>
          </div>
        </div>
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-3 px-2">
          ...
          <div className="space-y-0.5">
            <h2 className="text-2xl font-black text-zinc-900 dark:text-white tracking-tight">Financial Analytics</h2>
            <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Trends & Distribution</p>
          </div>
        </div>
            ...
            <div className="lg:col-span-2 bg-white dark:bg-white/5 backdrop-blur-xl p-4 sm:p-6 rounded-3xl border border-zinc-200 dark:border-white/10 shadow-2xl transition-all hover:shadow-emerald-500/5 group/budget overflow-hidden">
              <div className="flex justify-between items-center mb-8">
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Monthly Allocation</p>
                </div>
                  ...
                  <div key={`${budget.id}-${index}`} className="space-y-3 p-4 rounded-2xl bg-zinc-50/50 dark:bg-white/2 hover:bg-zinc-100 dark:hover:bg-white/5 transition-all border border-transparent hover:border-zinc-200 dark:hover:border-white/10">
                    <div className="flex justify-between items-end">
                      <div>
                        ...
                        <p className="text-sm font-black text-zinc-900 dark:text-white">{currencySymbol}{budget.spent.toLocaleString()} <span className="text-zinc-400 text-[10px] font-bold">/ {currencySymbol}{budget.amount.toLocaleString()}</span></p>
                      </div>
      ...
      {goals.length > 0 && (
        <div className="space-y-6">
          <div className="flex items-center gap-3 px-2">
            ...
            <div className="space-y-0.5">
              <h2 className="text-2xl font-black text-zinc-900 dark:text-white tracking-tight">Financial Goals</h2>
              <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Long-term Progress</p>
            </div>
          </div>
                    ...
                    <div className="flex justify-between items-start">
                      <div className="space-y-1">
                        ...
                        <p className="text-lg font-black text-zinc-900 dark:text-white">
                          ...
                          <span className="text-zinc-400 text-xs font-bold ml-1">/ {currencySymbol}{goal.targetAmount.toLocaleString()}</span>
                        </p>
                      </div>
